...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="highlight">
                <strong>📎 PDF Download:</strong> U kunt de volledige CV als PDF downloaden via de website door in te loggen en naar de CV te gaan. Klik op de "Export PDF" knop om de CV te downloaden.
            </div>
            
            <p><strong>Wat kunt u nu doen?</strong></p>
            <ul style="line-height: 1.8;">
                <li>📥 Download de CV als PDF via de website</li>
