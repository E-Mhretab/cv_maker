...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>Hierbij ontvangt u de CV van <strong>{{ $cv->name }}</strong> zoals aangevraagd. De CV is als PDF-bijlage toegevoegd aan deze e-mail.</p>
            ...
            <div class="highlight">
                <strong>📎 PDF Bijlage:</strong> De volledige CV is als PDF-bijlage toegevoegd aan deze e-mail. U kunt deze direct downloaden en gebruiken voor uw beoordeling.
            </div>
        ...
        <div class="footer">
            ...
            <p>Verzonden door: esey@businessdevelopment.es</p>
