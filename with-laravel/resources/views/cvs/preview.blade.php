...
<body class="bg-light">
    ...
    <div class="preview-actions">
        <!-- Desktop Buttons -->
        <a href="{{ route('cvs.index') }}" class="btn btn-secondary">
            <i class="fas fa-arrow-left me-1"></i>Back to List
        </a>
        <a href="{{ route('cvs.edit', $cv) }}" class="btn btn-warning">
        ...
        @auth
            <a href="{{ route('cvs.pdf', $cv) }}" class="btn btn-danger" target="_blank">
        ...
        @else
            ...
            <a href="{{ route('login') }}?redirect={{ urlencode(route('cvs.preview', $cv)) }}&message=export_required" class="btn btn-success">
                <i class="fas fa-file-code me-1"></i>Export XML
            </a>
        @endauth
        ...
        <div class="container">
            <div class="header-content">
                <div class="header-title">
                    ...
                    <p>{{ $cv->name }} - {{ ucfirst($cv->metadata->template_type ?? 'nathan') }} Template</p>
                </div>
