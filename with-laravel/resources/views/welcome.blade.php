...
@section('title', 'CV Builder Pro - Create Professional CVs in Minutes')
            ...
            <div class="col-lg-6">
                <div class="hero-content fade-in-up">
                    ...
                    <div class="hero-buttons">
                        ...
                        @auth
                            <a href="{{ route('cvs.index') }}" class="btn-hero btn-hero-secondary">
...
<section id="gallery" class="cv-gallery">
    <div class="container">
        ...
        <!-- Messages -->
        @if (session('message') && session('message') === 'logged_out')
