...
unset($__errorArgs, $__bag); ?>" 
                                           id="username" name="email" value="<?php echo e(old('email')); ?>" required>
                                </div>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="reg_username" name="username" value="<?php echo e(old('username')); ?>" required>
                                </div>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="reg_email" name="email" value="<?php echo e(old('email')); ?>" required>
                                </div>
                                <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
</html><?php /**PATH /Users/nathanjethoe/Documents/GitHub/cv_maker/resources/views/auth/login.blade.php ENDPATH**/ ?>