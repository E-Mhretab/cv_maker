...
if (!isset($_POST['template_type']) || !in_array($_POST['template_type'], ['nathan', 'esey'])) {
            ...
            <div class="col-lg-10">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h2 class="h4 mb-0">
                            <i class="fas fa-edit me-2"></i>Create CV - <?php echo ucfirst($templateType); ?> Template
                        </h2>
                        ...
                        <form action="cv_save.php" method="POST" id="cvForm">
                            ...
                            <div class="form-section">
                                <div class="d-grid gap-2 d-md-flex justify-content-md-between">
                                    <a href="cv_create.php" class="btn btn-secondary btn-lg">
