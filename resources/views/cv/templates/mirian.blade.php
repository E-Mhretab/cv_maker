...
<nav class="navbar navbar-dark mirian-header shadow-sm">
  <div class="container">
...
<header class="mirian-header text-white text-center py-5">
  <div class="container">
...
<div class="container my-5">
  ...
  <section class="mb-5">
    <h2 class="h3 mb-3" style="color: #667eea;"><i class="fas fa-user me-2"></i>Profile Summary</h2>
    <div class="card mirian-card border-0 shadow-sm">
      <div class="card-body">
  ...
  <div class="row">
    ...
    <div class="col-md-6 mb-4">
      <h2 class="h3 mb-3" style="color: #667eea;"><i class="fas fa-cogs me-2"></i>Skills</h2>
      <div class="card mirian-card border-0 shadow-sm">
        <div class="card-body">
    ...
    <div class="col-md-6 mb-4">
      <h2 class="h3 mb-3" style="color: #667eea;"><i class="fas fa-language me-2"></i>Languages</h2>
      <div class="card mirian-card border-0 shadow-sm">
        <div class="card-body">
          ...
          <div class="mb-3">
            <div class="d-flex justify-content-between align-items-center">
              ...
              <span class="badge" style="background-color: #667eea;">{{ ucfirst($language->proficiency) }}</span>
            </div>
          </div>
          @endforeach
        </div>
  ...
  <section class="mb-5">
    <h2 class="h3 mb-3" style="color: #667eea;"><i class="fas fa-briefcase me-2"></i>Work Experience</h2>
    @foreach($cv->workExperience as $work)
    <div class="card mirian-card border-0 shadow-sm mb-3">
      <div class="card-body">
  ...
  <section class="mb-5">
    <h2 class="h3 mb-3" style="color: #667eea;"><i class="fas fa-graduation-cap me-2"></i>Education</h2>
