...
<head>
    ...
    <style>
        .template-card { transition: all 0.3s ease; cursor: pointer; border: 2px solid transparent; }
        .template-card:hover { transform: translateY(-5px); box-shadow: 0 10px 25px rgba(0,0,0,0.15); border-color: #0d6efd; }
        .template-card.selected { border-color: #0d6efd; background-color: #f8f9fa; }
        .template-preview { height: 200px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 10px; display: flex; align-items: center; justify-content: center; color: white; font-size: 3rem; margin-bottom: 1rem; }
    </style>
</head>
<body class="bg-light">
            ...
            <div class="col-lg-8">
                <div class="card shadow">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('manage.cvs.createForm') }}" method="POST" id="templateForm">
                            @csrf
                            <div class="row">
                                <!-- Nathan Template -->
