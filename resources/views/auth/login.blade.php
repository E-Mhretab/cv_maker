    ...
    <div class="container d-flex justify-content-center align-items-center min-vh-100">
        <div class="auth-container">
            ...
            <div class="auth-content">
                ...
                @if (request()->query('message') === 'export_required')
                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                        <i class="fas fa-info-circle me-2"></i>Please login or create an account to export your CV as PDF or XML.
                        <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                    </div>
                @elseif (request()->query('message') === 'logged_out')
                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                ...
                <div class="tab-content mt-4" id="authTabsContent">
                    ...
                    <div class="tab-pane fade show active" id="login" role="tabpanel">
                        <form method="POST" action="{{ url('login') }}{{ request()->query('redirect') ? '?redirect=' . urlencode(request()->query('redirect')) : '' }}">
                            @csrf
                            <div class="mb-3">
                    ...
                    <div class="tab-pane fade" id="register" role="tabpanel">
                        <form method="POST" action="{{ url('register') }}{{ request()->query('redirect') ? '?redirect=' . urlencode(request()->query('redirect')) : '' }}">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-lock"></i></span>
                                    <input type="password" class="form-control" id="reg_password_confirmation" name="reg_password_confirmation" required>
                                </div>
                            </div>
